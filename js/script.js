...
const btn_form = document.querySelector(".btn__form");
const formValidation = ()=>{
    ...
    let name_val = name_value.match(nameFormat);
    if (!name_val){
    ...
    let email_val = email_value.match(mailFormat);
    if(!email_val){ 
...
email_name.addEventListener("keyup", formValidation);
form_name.addEventListener("keyup", formValidation);
